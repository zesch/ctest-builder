...
export class HomeComponent implements OnInit {
   ...
   * "!" means we expect a file to be there and not be null (otherwise a guard is needed,
   * see: https://stackoverflow.com/questions/49431880/ts2531-object-is-possibly-null)
